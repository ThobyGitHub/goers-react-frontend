...
function UpdateArea(props) {
  ...
  // function to call function in app.jsx to update a restaurant
  async function updateRestaurant(event) {
    event.preventDefault();
    await props.onUpdate(restaurant);
    props.onClose()
  }
  ...
  return (
    <Dialog open={props.open} onClose={props.onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        <form onSubmit={updateRestaurant} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <TextField
            label="Name"
            name="name"
